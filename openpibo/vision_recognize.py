...
Class:
:meth:`~openpibo.vision_recognize.vision_api`
:obj:`~openpibo.vision_recognize.Face`
:obj:`~openpibo.vision_recognize.Detect`
"""
...
class Face:
  """
Functions:
:meth:`~openpibo.vision_recognize.Face.detect`
:meth:`~openpibo.vision_recognize.Face.get_ageGender`
:meth:`~openpibo.vision_recognize.Face.get_age`
:meth:`~openpibo.vision_recognize.Face.get_gender`
:meth:`~openpibo.vision_recognize.Face.init_db`
:meth:`~openpibo.vision_recognize.Face.train_face`
:meth:`~openpibo.vision_recognize.Face.delete_face`
:meth:`~openpibo.vision_recognize.Face.recognize`
:meth:`~openpibo.vision_recognize.Face.get_db`
:meth:`~openpibo.vision_recognize.Face.save_db`
:meth:`~openpibo.vision_recognize.Face.load_db`
  ...
  * 얼굴로 나이/성별/감정을 추정합니다.
  ...
  example::
    ...
    from openpibo.vision_recognize import Face
...
class Detect:
  """
Functions:
:meth:`~openpibo.vision_recognize.Detect.detect_object`
:meth:`~openpibo.vision_recognize.Detect.detect_qr`
:meth:`~openpibo.vision_recognize.Detect.detect_pose`
:meth:`~openpibo.vision_recognize.Detect.analyze_pose`
:meth:`~openpibo.vision_recognize.Detect.classify_image`
:meth:`~openpibo.vision_recognize.Detect.object_tracker_init`
:meth:`~openpibo.vision_recognize.Detect.track_object`
:meth:`~openpibo.vision_recognize.Detect.detect_marker`
  ...
  * 이미지 분류
  ...
  example::
    ...
    from openpibo.vision_recognize import Detect
